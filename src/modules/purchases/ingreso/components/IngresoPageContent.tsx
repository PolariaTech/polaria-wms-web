...
import type { OrdenCompraRow, RecepcionCompraRow } from "../../shared/types/purchases.types";
import { RecepcionCompraModal } from "../../ingreso/components/RecepcionCompraModal";
