...
import {
  CREATION_SUBTITLE,
  CREATION_TITLE,
} from "@/modules/configurator/shared/constants/creation-options";
import type { CreationOptionId, CreationPanelProps } from "@/modules/configurator/shared/types/creation.types";
import { CreationOptionsGrid } from "@/modules/configurator/shared/components/CreationOptionsGrid";
